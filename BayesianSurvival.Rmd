...
# N: the number of uncensored observations
# t: the times of the uncensored observations
# N_cens: the number of censored items that are right censored at time t_cens
# t_cens: it is only observed that the part survived untile time t_cens.
